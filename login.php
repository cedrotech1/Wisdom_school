...
if (isset($_POST["login"])) {
  ...
  $sql = "select * from user where UserName='$AdminName' and Password='$password'";
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post"
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Please enter your AdminName.</div>
                      </div>
                    </div>
